...
(async () => {
  ...
  const blocks = [
    ...
    { type: 'paragraph', text: '여름만 되면 영업력이 떨어지는 건 비단 당신만의 문제가 아닙니다. 대부분의 보험설계사가 같은 고민을 해요.', style: { textAlign: 'center' } },
    { type: 'paragraph', text: '', style: { textAlign: 'center' } },
    ...
    { type: 'paragraph', text: '진정성 있는 일상 콘텐츠로 고객과의 친밀감을 쌓으세요. 무더위 속에서도 꾸준히 소통하는 모습이 고객에게 신뢰를 줍니다.', style: { textAlign: 'center' } },
    { type: 'paragraph', text: '', style: { textAlign: 'center' } },
    ...
    { type: 'paragraph', text: '촬영은 할 수 있어도 편집은 어렵죠. 그래서 영상편집외주가 필요합니다. 에이컷은 보험설계사 전용 숏폼 편집 아웃소싱 서비스를 제공합니다.', style: { textAlign: 'center' } },
    { type: 'paragraph', text: '', style: { textAlign: 'center' } },
  ...
  const v = await se.evaluate(() => {
    ...
    return {
      ...
      canvasText: canvas ? canvas.innerText.substring(0, 200) : '',
    };
  });
