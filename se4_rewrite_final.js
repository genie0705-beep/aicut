...
(async () => {
  ...
  const titleCheck = await se.evaluate(() => SmartEditor._editors['blogpc001'].getDocumentTitle());
  console.log('제목:', titleCheck);
  ...
  console.log('CTA:', v.hasCTA && v.hasEmail && v.hasHomepage ? '✅' : '❌');
  console.log('해시태그:', v.hashCount + '개');
  console.log('모바일 50자↑:', v.longParas + '개');
  console.log('');
  console.log(v.textLen > 1000 ? '✅ 정상!' : '⚠️');
