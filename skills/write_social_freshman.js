...
// 3개 섹션 텍스트 (FP 키워드 완전 제외)
const SECTIONS = [
  {
    img: 'aicut_blog_fp_main.png', // 기존 main 이미지 재사용
    text: [
  ...
  },
  {
    ...
    text: [
      ...
      '숏폼 영상이 가장 효과적입니다.',
      '',
      'GA·보험대리점 소속이라면 더더욱 중요합니다.',
      '개인 채널이 곧 신뢰 자산이 되기 때문입니다.',
    ]
  },
  {
    ...
    text: [
      ...
      '첫째, 일상 속 키워드를 자연스럽게.',
      '',
      '출근길 커피 한 잔에 #보험영업 #출근 #보험설계사',
      '저녁 마무리에 #보험상담 #계약 #사회초년생',
      '',
      '둘째, 보험 상품 키워드를 활용하세요.',
      '',
      '종신보험, 변액보험, 실비보험, 건강보험, 연금저축',
      '상담 내용에 녹이면 검색 노출이 올라갑니다.',
      '',
      '셋째, 꾸준함이 정답입니다. 📦',
      '',
      '하루 1개 릴스, 일주일에 3개 쇼츠.',
      '혼자 하기 어렵다면 전문 에디터의 도움을 받으세요.',
    ]
  },
  {
    img: 'aicut_blog_fp_card3.png',
    text: [
      '✅ 보험대리점 GA, 영상 편집 아웃소싱으로 성공한 사례',
      '',
      'A씨의 실제 이야기입니다.',
      '',
      '도입 전: 블로그 글만 올리는 SNS → 월 상담 5~8건',
      '',
      '도입 후: 주 5회 숏폼 정기 납품(에이컷)',
      '→ 월 상담 20~25건 (250% 상승) 📈',
      '',
      '비결은 간단했습니다.',
      '',
  ...
  },
  {
    ...
    text: [
      ...
      '',
      '#보험영업 #보험설계사 #사회초년생 #GA #보험대리점 #숏폼마케팅 #영상편집외주 #인스타그램마케팅 #릴스마케팅 #보험상담 #종신보험 #변액보험 #실비보험 #건강보험 #연금저축 #보험마케팅 #SNS마케팅 #영상콘텐츠 #출근 #보험일상 #에이컷 #숏폼영상 #릴스 #유튜브쇼츠 #틱톡마케팅 #영상편집 #마케팅전략 #하반기준비 #보험대행 #정기납품'
    ]
  }
];
  ...
  await wp.evaluate(() => {
    document.querySelectorAll('img').forEach(img => {
      ...
      const altMap = {
        ...
        'card3.png': '보험대리점 GA 영상 편집 아웃소싱 사례',
    ...
    const h2t = ['☀️ 보험 영업', '📋 보험 영업 사회 초년생', '✅ 보험대리점 GA', '🎯 지금 시작하세요'];
    document.querySelectorAll('.se-text-paragraph').forEach(p => {
    ...
    const kws = ['보험영업', '보험설계사', '사회초년생', '보험대리점'];
    document.querySelectorAll('.se-text-paragraph').forEach(p => {
