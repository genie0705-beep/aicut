...
// 각 섹션: 이미지 파일 + 텍스트 줄 배열
const SECTIONS = [
  {
    img: 'aicut_blog_fp_main.png',
    text: ['보험설계사 FP라면 상상해보세요.','','당신의 SNS에 잠재 고객이 먼저 찾아옵니다.','','"○○FP님 릴스 봤어요. 보험 상담 받고 싶어요."','','텍스트와 이미지만으로는 더 이상 경쟁력이 없습니다.','','숏폼 영상 마케팅이 선택이 아닌 필수가 된 이유입니다. 💡','','이 글에서는 상반기 보험 마케팅 트렌드와 하반기 숏폼 전략을 구체적으로 알려드립니다.']
  },
  {
    img: 'aicut_blog_fp_card1.png',
    text: ['☀️ 상반기 FP 마케팅, 왜 영상인가','','2026년 상반기, 보험업계에 큰 변화가 있었습니다.','','릴스·쇼츠 기반 FP 브랜딩이 완전히 정착됐습니다.','','FP 개인 SNS에서 숏폼 영상이 차지하는 비중이 70%를 넘었습니다.','','영상으로 신뢰를 주는 FP가 상담 예약에서 압도적 우위를 보이고 있습니다.','','문제는 직접 찍고 편집하려면 시간이 너무 많이 든다는 겁니다.','','여기서 영상편집외주의 필요성이 생겼습니다. ✂️','','FP가 직접 촬영하고, 전문가가 편집하는 구조가 가장 효율적입니다.','','하루 1~2개 숏폼을 정기 납품받는 FP가 벌써 일반화되었습니다.']
  },
  {
    img: 'aicut_blog_fp_card2.png',
    text: ['📋 FP 숏폼 마케팅, 이렇게 준비하세요','','첫째, 채널별 최적화가 필요합니다.','','릴스(인스타)는 15~30초 감성형이 효과적입니다. 쇼츠(유튜브)는 30~60초 정보형 콘텐츠가 좋습니다.','','틱톡은 트렌드 밈 기반 가벼운 콘텐츠가 통합니다.','','둘째, 정기 납품이 정답입니다. 📦','','FP 혼자 촬영·편집·업로드까지 하면 2주도 못 버팁니다.','','숏폼 마케팅은 꾸준함이 생명입니다. 전문 영상편집외주 업체와 월 정기 계약을 맺으세요.','','안정적인 콘텐츠 파이프라인을 구축한 FP가 진짜 승자입니다.','','상반기 시도해본 FP는 압니다. 혼자 하는 숏폼은 지속 불가능합니다.']
  },
  {
    img: 'aicut_blog_fp_card3.png',
    text: ['✅ 영상편집외주, FP가 선택해야 하는 이유','','FP A님의 실제 사례입니다.','','도입 전: 블로그와 이미지 위주 SNS → 월 상담 10~12건','','도입 후: 주 5회 숏폼 정기 납품(에이컷) → 월 상담 28~32건 (180% 상승) 📈','','비결은 간단했습니다.','','매일 같은 시간, 같은 퀄리티로 영상이 꾸준히 올라갔습니다. 알고리즘이 FP의 콘텐츠를 우선 노출하기 시작했습니다.','','FP 브랜딩에서 가장 중요한 것은 신뢰의 축적입니다.','','A님의 말: "영상편집외주 덕분에 상담에 집중할 수 있었습니다."','','영상 하나하나가 고객의 신뢰 자산이 됩니다.']
  },
  {
    img: 'aicut_blog_fp_cta.png',
    text: ['🎯 하반기, 지금 준비하세요','','하반기 핵심 키워드는 정기성과 신뢰감입니다.','','FP 브랜딩, 영상편집외주, 숏폼 마케팅 — 이 세 가지가 2026년 하반기 보험 마케팅의 핵심입니다.','','에이컷은 FP·보험설계사 전용 숏폼 아웃소싱 서비스를 제공합니다.','','✅ 월 20~40편 정기 납품','✅ FP 브랜딩 맞춤 편집 스타일','✅ 촬영 가이드 제공','✅ 24~48시간 이내 빠른 납품','','하반기 전략을 세우는 지금이 가장 좋은 타이밍입니다.','','지금 상담 신청하면 FP 브랜딩 맞춤 전략 제안서를 무료로 제공합니다.','','📞 카카오톡: https://pf.kakao.com/_GIesX/chat','📧 이메일: master@aicut.co.kr','🌐 홈페이지: https://aicut.co.kr','','#보험마케팅 #FP브랜딩 #보험설계사 #영상편집외주 #숏폼마케팅 #하반기전략 #영상마케팅 #릴스마케팅 #유튜브쇼츠 #틱톡마케팅 #AI영상편집 #SNS마케팅 #보험영상 #FP마케팅 #보험설계사마케팅 #여름마케팅 #상반기분석 #콘텐츠마케팅 #에이컷 #영상편집 #숏폼영상 #릴스 #쇼츠 #인스타그램마케팅 #보험상담 #예약률 #FP브랜딩전략 #마케팅아웃소싱 #정기납품 #영상콘텐츠']
  }
];
...
async function main() {
  ...
  let wp = ctx.pages().find(p => p.url().includes('PostWriteForm'));
  if (!wp) {
  ...
  for (let i = 0; i < SECTIONS.length; i++) {
    ...
    const fullPath = path.join(WS, sec.img);
    ...
    console.log('  [' + (i+1) + '/5] ' + sec.img);
  }

  // SEO + 정렬
  console.log('2. SEO 최적화');
  await wp.evaluate(() => {
    const altMap = {
    ...
    // H2
    const h2t = ['☀️ 상반기 FP 마케팅', '📋 FP 숏폼 마케팅', '✅ 영상편집외주', '🎯 하반기'];
    document.querySelectorAll('.se-text-paragraph').forEach(p => {
  ...
  const v = await wp.evaluate(() => {
    ...
    const imgInfo = Array.from(imgs).map(img => ({
      ...
      alt: (img.getAttribute('alt') || '').substring(0,20),
    ...
    return {
      ...
      AICUT_본문: !ft.includes('AICUT') ? '✅ 없음' : '⚠️ 있음'
    };
  });
  console.log('\n=== 최종 검증 ===');
