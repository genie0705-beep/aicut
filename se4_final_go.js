...
(async () => {
  ...
  // 레퍼런스 스타일 + Strong 5개 이상 + 본문 1500자
  const blocks = [
  ...
  console.log('본문:', v.totalLen + '자');
  console.log('줄:', v.lineCount + '줄 (평균 ' + v.avgLen + '자)');
  console.log('Strong:', v.strongCount + '개');
  console.log('H2/H3:', v.headingCount + '개');
  console.log('해시태그:', v.hashCount + '개');
  console.log('중복키워드:', v.kwBok + '회 | 보양식:', v.kwFood + '회');
  console.log('50자↑:', v.longLines + '개');
  console.log('');  
  console.log(v.totalLen >= 1500 ? '✅ 1500자 충족!' : '⚠️ ' + (1500 - v.totalLen) + '자 부족');
