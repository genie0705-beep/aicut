...
(async () => {
  ...
  await se.evaluate(() => {
    ...
    data.document.blocks = [
      ...
      { type: 'paragraph', text: '초복이 지나고 중복을 앞둔 지금, 더위에 지친 몸을 달랠 보양식이 필요한 계절입니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading2', text: '🗓️ 2026 중복, 7월 22일', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '초복(7/12)이 지나고, 2026년 중복은 7월 22일(수)입니다. 말복은 8월 11일이에요.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '복날에는 더위를 이기기 위해 보양식을 먹는 전통이 있습니다. 지금이 바로 준비할 타이밍!', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading2', text: '🍗 중복 보양식 추천 TOP 5', style: { textAlign: 'center' } },
      { type: 'heading3', text: '1. 삼계탕', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '복날 하면 가장 먼저 떠오르는 음식. 닭 한 마리에 인삼·대추·찹쌀을 넣고 끓여 원기 회복에 최고입니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading3', text: '2. 장어구이', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '비타민 A와 D가 풍부한 대표 보양식. 고소한 장어구이에 초장 찍어 먹으면 스테미나 충전 완료!', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading3', text: '3. 추어탕', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '예로부터 복날에 먹던 전통 음식. 칼칼한 국물이 더운 날씨에 입맛을 살려줍니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading3', text: '4. 전복죽', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '입맛 없을 때 부담 없이 먹기 좋은 보양식. 소화도 잘되고 영양도 풍부해 남녀노소 좋아합니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading3', text: '5. 소고기 영양밥', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '단백질과 철분이 풍부한 소고기로 영양밥을 지어 먹으면 든든하고 맛있는 한 끼가 완성됩니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading2', text: '📸 음식 인증샷, 잘 찍는 3가지 꿀팁', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '맛있는 음식을 먹을 때 인증샷은 필수! 더 맛있어 보이는 사진을 위한 꿀팁입니다.', style: { textAlign: 'center' } },
      { type: 'heading3', text: 'TIP 1. 자연광 활용', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '식당 누런 조명보다 창가 자연광이 최고. 음식이 훨씬 선명하고 맛있어 보여요.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading3', text: 'TIP 2. 45도 앵글', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '위에서 내려찍는 탑뷰보다 45도 각도가 가장 무난. 음식의 높이감과 재질감을 살려줍니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading3', text: 'TIP 3. 포트레이트 모드', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '스마트폰 인물 모드로 찍으면 배경이 흐려져 음식이 더 돋보입니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading2', text: '🎬 찍은 음식 영상, 릴스로 만들기', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '사진만으로 부족하다면 음식 릴스에 도전해보세요. 끓는 순간부터 식탁까지의 과정을 영상으로 담으면 훨씬 많은 공감을 얻습니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '하지만 영상 편집은 쉽지 않죠. 촬영은 폰으로 하고, 편집은 에이컷에 맡기세요.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
      { type: 'heading2', text: '💬 지금 상담하고 중복 준비하세요', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '중복에 먹을 맛있는 음식, 인증샷과 릴스로 기록하고 싶다면 에이컷이 도와드립니다.', style: { textAlign: 'center' } },
      { type: 'paragraph', text: '', style: { textAlign: 'center' } },
  ...
  console.log('내용:', v.hasBody ? '✅' : '❌');
  console.log('해시태그:', v.hasHash ? '✅' : '❌');
  console.log('CTA:', v.hasCTA ? '✅' : '❌');
  console.log('');
  console.log(v.textLen > 500 ? '✅ 작성 완료!' : '⚠️ 재시도 필요');
