...
const POSTS = [
  {
    url: 'https://www.instagram.com/aicut.official/p/DY9KdbFGfie/',
  ...
  {
    url: 'https://www.instagram.com/aicut.official/p/DY9KXBpmffO/',
  ...
  {
    url: 'https://www.instagram.com/aicut.official/p/DY9KQibmZSu/',
  ...
  {
    url: 'https://www.instagram.com/aicut.official/p/DY9KKOZmWxD/',
  ...
  {
    url: 'https://www.instagram.com/aicut.official/p/DY9KDv-GZ8S/',
...
async function deletePost(page, postUrl) {
  ...
  const opt = await page.evaluate(() => {
    for (const svg of document.querySelectorAll('svg')) {
      ...
      if (t && (t.textContent === '옵션 더 보기' || t.textContent === 'More options')) {
